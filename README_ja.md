...
> **採用担当者:** [設計上のこだわり § 60秒](#採用担当者向け--60秒で読める) · エンジニア: [FORK_CURSOR.md](./docs/FORK_CURSOR.md) · [CURSOR_MCP_TODO.md](./docs/CURSOR_MCP_TODO.md)
...
> **採用担当者・外部レビュア向け** — 設計思想と成熟度の概要。エンジニア向けタスク一覧ではありません（内部 runbook: [CURSOR_MCP_TODO.md](./docs/CURSOR_MCP_TODO.md)）。
