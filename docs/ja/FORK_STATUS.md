...
| **TS-26 CLI metadata + README 図** | 2026/06/22 22:05:21 JST | TS-26 ADR；B-6 runbook/backlog；README コード準拠 mermaid（index.ts · legacy spawn · SRP 分岐） |
...
| タイムスタンプ (JST) | 変更 |
|---------------------|------|
| 2026/06/22 22:05:21 JST | TS-26 CLI metadata ADR；B-6 Track B；README コード準拠アーキテクチャ図；関連 doc 同期 |
