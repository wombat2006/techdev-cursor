...
| SRP monolith splits | Shim + module dirs (13 done, Phase 2 #3) | [SRP_MONOLITH_REFACTOR.md](docs/SRP_MONOLITH_REFACTOR.md) · [SRP_REFACTOR_DEPENDENCY_ORDER.md](docs/SRP_REFACTOR_DEPENDENCY_ORDER.md) |
